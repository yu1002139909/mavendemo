				...
				<tbody>
					<c:choose>
						<c:when test="${not empty requestScope.findStu}">
							<c:forEach var="stu" items="${requestScope.findStu}">
								<tr>
									<td class="tdline">${stu.name}</td>
									<td class="tdline">${stu.loginId}</td>
									<td class="tdline">${stu.age}</td>
									<td class="tdline">${stu.gender}</td>
									<td class="tdline">${stu.college}</td>
									<td class="tdline">${stu.address}</td>
