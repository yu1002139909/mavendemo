    ...
    <div class="menu fleft">
    	<ul>
			...
			<li class="subMenu"><a href="#" target="right">管理模块</a>
			   <ul>
					<li><a href="${pageContext.request.contextPath}/techaerservlet?method=pagelist" target="right">教师管理</a></li>
                    <li><a href="${pageContext.request.contextPath}/courseservlet?method=courselist" target="right">安排课程</a></li>
					<li><a href="${pageContext.request.contextPath}/studentservlet?method=stupage"  target="right">学生管理</a></li>
                    <li><a href="${pageContext.request.contextPath}/courseservlet?method=addview"  target="right">增加课程</a></li>
                </ul>
            </li>
